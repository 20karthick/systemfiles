    ...
    def web_login(self, redirect=None, **kw):
        ...
        if request.httprequest.method == 'POST':
            ...
            try:
                ...
                if user.has_group('mena_hr_dashboard.group_hr_dashboard_user'):
                    menu_id = ir_model_data._xmlid_lookup('mena_hr_dashboard.custom_dashboard_menu')[2]
                    action_id = ir_model_data._xmlid_lookup('mena_hr_dashboard.custom_hr_dashboard_action')[2]
                    redirect = "/web#menu_id=%s&action=%s" % (menu_id, action_id)
                    return request.redirect(redirect)
                else:
